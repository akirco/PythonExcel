...
def init():
    ...
    res2_list = (
        ...
        723, 724, 725, 726, 727, 728, 729, 730, 731, 732, 733, 734, 735, 736, 737, 738, 739, 740, 741, 742, 621, 622
    )
...
def get_user_data(sel_id):
    ...
    if user_list is None:
        ...
        # print('交集数据：', list(set(nt).intersection(set(sel_list))))
        ...
        if lens >= 0:
            ...
            # df = values[values['A'].isin(new_sel_list)]
...
def del_extra_files():
    ...
    for i in file_list:
        if os.path.splitext(i)[1] != '.py' and os.path.splitext(i)[1] != '.zip' and os.path.splitext(i)[
            ...
            1] != '.md' and i != 'arch' and os.path.splitext(i)[1] != '.json':
            shutil.rmtree(i)
            os.mkdir(i)
